...
//					+bean.getEname()+"\",\"hiredate\":\""+(bean.getHiredate()==null?null:bean.getHiredate().getTime())+"\"}");	
//		}
//		
//		out.print("]}");
		...
		for(EmpVo bean : empDao.findAll()) {
			...
			json.addProperty("hiredate", (bean.getHiredate()==null?null:bean.getHiredate().getTime()));
			arr.add(json);
		}
...
//		res.getWriter().print(json.toString());
	...
	public void testApi(HttpServletResponse res) throws IOException {
		String msg="{\"empno\":+1234,\"ename\":\"asd\"}";
		Gson gson=new Gson();
		EmpVo bean=gson.fromJson(msg,EmpVo.class);
