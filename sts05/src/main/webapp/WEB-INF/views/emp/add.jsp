...
<form class="form-horizontal" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="ename" placeholder="ename" name="ename" value="tester">
    </div>
  </div>
  <div class="form-group">
    <label for="" class="col-sm-2 control-label">sal</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="sal" placeholder="sal" name="sal" value="1">
    </div>
  </div>
  <div class="form-group">
    <label for="" class="col-sm-2 control-label">job</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="job" placeholder="job" name="job" value="test">
    </div>
  </div>
  <div class="form-group">
